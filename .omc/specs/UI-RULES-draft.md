...
> **Draft for `docs/UI-RULES.md`** — produced by the 2026-08-15 deep-dive UI audit. Promote verbatim, then keep it under ~350 lines forever. `docs/design.md` (48KB, stale since 14 May, colour system inverted vs shipped CSS) is superseded for rules; keep it as reference only, banner-marked "superseded by UI-RULES.md".
>

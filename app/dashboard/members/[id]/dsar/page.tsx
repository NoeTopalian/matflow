...
export default async function MemberDsarPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      {erased && (
        <div className="rounded-2xl border p-4 bg-destructive/10 border-destructive/25 text-destructive">
      ...
      <section className={`rounded-2xl border p-5 ${erased ? "" : "bg-destructive/[0.06] border-destructive/20"}`} style={erased ? { background: "var(--sf-1)", borderColor: "var(--bd-default)" } : undefined}>
        <h2 className="text-base font-semibold mb-2" style={{ color: "var(--tx-1)" }}>
        ...
        <p className="text-xs mb-4 text-destructive/85">

...
export const JOURNEYS: readonly Journey[] = [
  ...
  { id: "J65", name: "Public club page renders for a real club; every non-public state 404s identically", group: "L-B", primaryRole: "anonymous", allowed: ["anonymous"], na: [...ACCOUNTS, ...NOT_TENANT], routes: ["/[slug]"], note: "M3. No session; branding-only fields. Unknown, suspended, cancelled and soft-deleted clubs all 404 the same (no enumeration oracle), reusing GET tenant/[slug]'s discipline. A reserved slug (a real route folder) never renders as a club." },

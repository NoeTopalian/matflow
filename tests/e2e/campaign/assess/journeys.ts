...
export const JOURNEYS: readonly Journey[] = [
  ...
  { id: "J04", name: "Password login, lockout at ten, owner unlock", group: "L-A", primaryRole: "owner", allowed: ACCOUNTS, na: ["child", "kiosk"], routes: ["POST auth/[...nextauth]", "POST members/[id]/unlock", "/login"], note: "unlock is owner/manager; a lockout is not a 429" },
  ...
  { id: "J33", name: "Cancel a session (unreachable today)", group: "L-D", primaryRole: "owner", allowed: OM, na: ["child", "kiosk", "operator", "anonymous"], routes: ["POST classes/[id]/instances"], note: "cancelSchema is dead; an advertised cancel that cannot be reached is an ERROR" },
  ...
  { id: "J50", name: "Billing: subscribe, cancel, payment methods, honest when inert", group: "L-F", primaryRole: "member", allowed: ["member", "parent"], na: ["child", "kiosk", "operator", "anonymous"], routes: ["GET member/me/subscriptions", "GET member/me/payments", "GET stripe/portal", "POST member/subscriptions/cancel", "/member/billing"] },
  { id: "J51", name: "Shop to a pay-at-desk order; no staff Orders screen", group: "L-F", primaryRole: "member", allowed: ["member", "owner"], na: ["child", "kiosk", "operator", "anonymous"], routes: ["GET member/products", "GET member/shop-config", "POST member/checkout", "GET products", "POST products", "PATCH products/[id]", "DELETE products/[id]", "POST orders/[id]/mark-paid", "/member/shop"], note: "mark-paid has no screen (X-6 K13)" },

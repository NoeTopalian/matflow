...
// Per-kind accent for the "Needs attention today" rows. Tokens, not hues:
// these arrived as Tailwind-500 values that measured 2.15-3.76:1 on the light
// staff card, i.e. every category label failed the contrast floor. The token
// definitions in globals.css carry the measured ratios.
const ACTION_KIND_COLOR: Record<ActionItemKind, string> = {
  money: "var(--cat-money)",
  retention: "var(--cat-retention)",
  admin: "var(--cat-admin)",
  moment: "var(--cat-moment)",
};
